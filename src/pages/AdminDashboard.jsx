...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchCoupons = async () => {
      try {
        const response = await axios.get("HOST/api/admin/coupons");
  ...
  const handleAddCoupon = async () => {
    try {
      const response = await axios.post("HOST/api/admin/coupon/add", {
        code: couponCode,
      });
  ...
  const handleToggleCoupon = async (code) => {
    try {
      const response = await axios.post("HOST/api/admin/coupon/toggle", {
        code,
      });
      toast.success(`${response.data.message}`);
      setCoupons(
  ...
  const handleUpdateCoupon = async () => {
    try {
      const response = await axios.post("HOST/api/admin/updateCoupon", {
        code,
        newCode,
      });
      toast.success(`${response.data.message}`);
